...
It's difficult to implement Romano and Wolf's resampling multiple adjustment procedure with one-sided tests in R - instead I demonstrate that the procedure is too conservative when considering data generated under a two-sided null hypothesis. With 1000 draws of the data we'd expect to observe approximately 5\% of test statistics to be greater than the _original_ critical value - however it's clear that 
