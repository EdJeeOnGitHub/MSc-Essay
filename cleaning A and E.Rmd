...
first_stage_interactions <- bind_rows(first_stage_interactions_90, first_stage_interactions_80) 
...
first_stage_interactions %>% 
  ...
  ggplot(aes(x = rank, y = dydx_instrument, ymin = dydx_lo, ymax = dydx_hi, colour = dataset)) +
  geom_point() +
