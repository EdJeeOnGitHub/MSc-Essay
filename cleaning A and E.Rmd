...
I generate 1000 draws of data using the following data generating process:
...
first_stage_interactions_maimonides %>% 
  ...
  scale_x_continuous(trans=negative_log_trans(10)) +
  scale_y_continuous(trans=negative_log_trans(10)) +
  labs(title = "QQ plot of P-values First Stage Interactions - Maimonides' Instrument",
